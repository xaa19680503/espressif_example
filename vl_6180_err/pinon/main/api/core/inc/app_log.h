...
#if 1
#define logi                                                                   \
  (printf("[I] %ld [%s:%d] [%s()] ",xTaskGetTickCount() * portTICK_PERIOD_MS, __FILE__, __LINE__, __func__))
#else
#define logi
#endif
...
#if 1
#define loge                                                                   \
  (printf("[E] %ld [%s:%d] [%s()] ",xTaskGetTickCount() * portTICK_PERIOD_MS, __FILE__, __LINE__, __func__))
#else
#define loge
#endif
